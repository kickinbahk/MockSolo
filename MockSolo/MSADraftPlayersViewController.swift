...
class DraftPlayersViewController: UIViewController {
  let playerList = [
    Player(rank: 1, name: "Mike Trout", position: ["OF", "Util", "Bench"], team: "LAA"),
    Player(rank: 2, name: "Paul Goldschmidt", position: ["1B", "Util", "Bench"], team: "ARI"),
    Player(rank: 3, name: "Bryce Harper", position: ["OF", "Util", "Bench"], team: "WAS"),
    Player(rank: 4, name: "Clayton Kershaw", position: ["SP", "Bench"], team: "LAD"),
    Player(rank: 5, name: "Josh Donaldson", position: ["3B", "Util", "Bench"], team: "TOR"),
    Player(rank: 6, name: "Giancarlo Stanton", position: ["OF", "Util", "Bench"], team: "MIA"),
    Player(rank: 7, name: "Manny Machado", position: ["3B", "Util", "Bench"], team: "BAL"),
    Player(rank: 8, name: "Andrew McCutchen", position: ["OF", "Util", "Bench"], team: "PIT"),
    Player(rank: 9, name: "Nolan Arenado", position: ["3B", "Util", "Bench"], team: "COL"),
    Player(rank: 10, name: "Carlos Correa", position: ["SS", "Util", "Bench"], team: "HOU"),
    Player(rank: 11, name: "Jose Altuve", position: ["2B", "Util", "Bench"], team: "HOU"),
    Player(rank: 12, name: "Anthony Rizzo", position: ["1B", "Util", "Bench"], team: "CHC"),
    Player(rank: 13, name: "Jose Bautista", position: ["OF", "Util", "Bench"], team: "TOR"),
    Player(rank: 14, name: "Kris Bryant", position: ["3B", "Util", "Bench"], team: "CHC"),
    Player(rank: 15, name: "Miguel Cabrera", position: ["1B", "Util", "Bench"], team: "DET"),
    Player(rank: 16, name: "Edwin Encarnacion", position: ["1B", "Util", "Bench"], team: "TOR"),
    Player(rank: 17, name: "Mookie Betts", position: ["OF", "Util", "Bench"], team: "BOS"),
    Player(rank: 18, name: "Dee Gordon", position: ["2B", "Util", "Bench"], team: "MIA"),
    Player(rank: 19, name: "Max Scherzer", position: ["SP", "Bench"], team: "WAS"),
    Player(rank: 20, name: "Jose Abreu", position: ["1B", "Util", "Bench"], team: "CWS"),
    Player(rank: 21, name: "Jake Arrieta", position: ["SP", "Bench"], team: "CHC"),
    Player(rank: 22, name: "Chris Sale", position: ["SP", "Bench"], team: "CWS"),
    Player(rank: 23, name: "Starling Marte", position: ["OF", "Util", "Bench"], team: "PIT"),
    Player(rank: 24, name: "David Price", position: ["SP", "Bench"], team: "BOS" ),
    Player(rank: 25, name: "Charlie Blackmon", position: ["OF", "Util", "Bench"], team: "COL"),
    Player(rank: 26, name: "Madision Bumgarner", position: ["SP", "Bench"], team: "SF"),
    Player(rank: 27, name: "J.D. Martinez", position: ["OF", "Util", "Bench"], team: "DET"),
    Player(rank: 28, name: "Joey Votto", position: ["1B", "Util", "Bench"], team: "CIN"),
